...
const AddValidatorExpert: React.FC<BaseConsoleToolProps> = ({ onSuccess }) => {
  ...
  const [userPChainBalanceNlux, setUserPChainBalanceNlux] = useState<bigint | null>(null);
        ...
        <div className="space-y-6">
          ...
          <Steps>
            ...
            <Step>
              ...
              <p className="text-sm text-gray-500 mb-4">
                Call the <a href="https://github.com/luxfi/icm-contracts/blob/main/contracts/validator-manager/ValidatorManager.sol#L308" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">initiateValidatorRegistration</a> function on the Validator Manager contract. This transaction will emit a <a href="/docs/lps/77-reinventing-subnets#registerl1validatormessage" className="text-blue-600 hover:text-blue-800 underline">RegisterL1ValidatorMessage</a> warp message.
              </p>
            ...
            <Step>
              <h2 className="text-lg font-semibold">Sign RegisterL1ValidatorMessage & Submit RegisterL1ValidatorTx to Platform-Chain</h2>
              <p className="text-sm text-gray-500 mb-4">
                Sign the emitted <a href="/docs/lps/77-reinventing-subnets#registerl1validatormessage" className="text-blue-600 hover:text-blue-800 underline">RegisterL1ValidatorMessage</a> and submit a <a href="/docs/lps/77-reinventing-subnets#registerl1validatortx" className="text-blue-600 hover:text-blue-800 underline">RegisterL1ValidatorTx</a> to Platform-Chain. This transaction will emit a <a href="/docs/lps/77-reinventing-subnets#l1validatorregistrationmessage" className="text-blue-600 hover:text-blue-800 underline">L1ValidatorRegistrationMessage</a> warp message.
              </p>
            ...
            <Step>
              ...
              <p className="text-sm text-gray-500 mb-4">
                Complete the validator registration by signing the Platform-Chain <a href="/docs/lps/77-reinventing-subnets#l1validatorregistrationmessage" className="text-blue-600 hover:text-blue-800 underline">L1ValidatorRegistrationMessage</a> and calling the <a href="https://github.com/luxfi/icm-contracts/blob/main/contracts/validator-manager/ValidatorManager.sol#L425" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">completeValidatorRegistration</a> function on the Validator Manager contract.
              </p>
