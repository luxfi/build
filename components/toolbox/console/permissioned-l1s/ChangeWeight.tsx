        ...
        <div className="space-y-6">
          ...
          <Steps>
            ...
            <Step>
              ...
              <p className="text-sm text-gray-500 mb-4">
                Start the weight change process by specifying the validator and new weight and calling the <a href="https://github.com/luxfi/icm-contracts/blob/main/contracts/validator-manager/ValidatorManager.sol#L642" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">initiateValidatorWeightUpdate</a> function on the Validator Manager contract. This transaction will emit an <a href="/docs/lps/77-reinventing-subnets#l1validatorweightmessage" className="text-blue-600 hover:text-blue-800 underline">L1ValidatorWeightMessage</a> warp message.
              </p>
            ...
            <Step>
              <h2 className="text-lg font-semibold">Sign L1ValidatorWeightMessage & Submit SetL1ValidatorWeightTx to Platform-Chain</h2>
              <p className="text-sm text-gray-500 mb-4">
                Sign the <a href="/docs/lps/77-reinventing-subnets#l1validatorweightmessage" className="text-blue-600 hover:text-blue-800 underline">L1ValidatorWeightMessage</a> and submit a <a href="/docs/lps/77-reinventing-subnets#setl1validatorweighttx" className="text-blue-600 hover:text-blue-800 underline">SetL1ValidatorWeightTx</a> to the Platform-Chain.
              </p>
            ...
            <Step>
              <h2 className="text-lg font-semibold">Sign Platform-Chain L1ValidatorWeightMessage & Submit completeValidatorWeightUpdate on Validator Manager contract</h2>
              <p className="text-sm text-gray-500 mb-4">
                Complete the weight change by signing the Platform-Chain <a href="/docs/lps/77-reinventing-subnets#l1validatorweightmessage" className="text-blue-600 hover:text-blue-800 underline">L1ValidatorWeightMessage</a> and calling the <a href="https://github.com/luxfi/icm-contracts/blob/main/contracts/validator-manager/ValidatorManager.sol#L690" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">completeValidatorWeightUpdate</a> function on the Validator Manager contract.
              </p>
