...
export function DocsDropdown({
  ...
  const options: Option[] = [
    ...
    {
      title: "Lux Protocol",
      description: "Learn about Lux",
      icon: <SproutIcon />,
      url: "/learn",
    },
    {
      title: "Smart Contracts",
      description: "Build Apps on Lux",
    ...
    {
      title: "API Docs",
      description: "Lux API References",
      icon: <Webhook />,
      url: "/api-reference",
    },
  ];
...
export function AcademyDropdown() {
  const options: Option[] = [
    ...
    },
    {
      ...
      url: "https://academy.lux.network/course/blockchain-fundamentals",
    },
    {
      title: "Lux Fundamentals",
      description: "Overview of Lux Consensus, L1s, and VMs.",
      icon: <Triangle className="w-5 h-5" />,
      url: "https://academy.lux.network/course/lux-fundamentals",
    },
    {
      title: "Interchain Messaging",
      description: "Build cross-chain dApps on Lux.",
      icon: <MailIcon className="w-5 h-5" />,
      url: "https://academy.lux.network/course/interchain-messaging",
    },
    {
      title: "Interchain Token Transfer",
      description: "Transfer assets between Lux blockchains.",
      icon: <ArrowLeftRight className="w-5 h-5" />,
      url: "https://academy.lux.network/course/interchain-token-transfer",
    },
    {
      title: "Customizing the EVM",
      description: "Add custom precompiles to the EVM.",
      icon: <SquareCode className="w-5 h-5" />,
      url: "https://academy.lux.network/course/customizing-evm",
    },
    {
      title: "Layer 1 Tokenomics",
      description: "Design tokenomics for your Lux L1.",
      icon: <Coins className="w-5 h-5" />,
      url: "https://academy.lux.network/course/l1-tokenomics",
    },
    {
      title: "AvaCloud APIs",
      description: "Use AvaCloud APIs to build web apps.",
      icon: <Webhook className="w-5 h-5" />,
      url: "https://academy.lux.network/course/avacloudapis",
    },
    {
      title: "HyperSDK",
      description: "Build high-performance blockchains with HyperSDK.",
      icon: <TerminalIcon className="w-5 h-5" />,
      url: "https://academy.lux.network/course/hypersdk",
    },
  ];
  return <RootToggle options={options} />;
}
...
export function GrantsDropdown() {
  const options: Option[] = [
    ...
    },
    {
      ...
      url: "https://www.lux.network/retro9000",
    },
    {
      title: "infraBUIDL()",
      description:
      ...
      url: "https://www.lux.network/infrabuidl-program",
    },
    {
      title: "Codebase",
      description:
      ...
      url: "https://codebase.lux.network/",
    },
    {
      title: "Blizzard Fund",
      description:
        "VC fund investing in innovative entrepreneurs driving growth on Lux",
...
export function DropDownBar(): React.ReactElement {
  return (
    <div className="hidden sm:flex overflow-hidden items-center pl-4 space-x-3">
