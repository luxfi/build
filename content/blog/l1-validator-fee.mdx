...
Introduced with ACP-77, [Lux L1 Validators](https://build.lux.network/guides/subnet-vs-l1-validators) enable the creation of sovereign L1
...
[ACP-77](/docs/acps/77-reinventing-subnets#parameters), can be retrieved with the Platform-Chain API
