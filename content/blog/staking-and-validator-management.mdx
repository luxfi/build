...
Introduced with LP-77, [Lux L1 Validators](https://build.lux.network/guides/subnet-vs-l1-validators) 
...
LP-77 enables any Lux L1 to independently manage its own validators. When an L1 network is established, the
