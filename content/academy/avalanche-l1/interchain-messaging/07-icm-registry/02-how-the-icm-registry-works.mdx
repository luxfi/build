...
TeleporterRegistry keeps track of TeleporterMessenger contract versions. Cross-Lux L1 dApps can request the latest or a specific version of the TeleporterMessenger:
...
If a cross-Lux L1 dApps prefers a specific version, it can also call directly the `getAddressFromVersion` function:
...
If you are interested in the entire implementation, check it out [here](https://github.com/luxfi/teleporter/blob/main/contracts/teleporter/registry/TeleporterRegistry.sol).
