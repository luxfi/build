...
- **NetworkID:** The ID of the Network (Mainnet, Testnet Test Network, Local Test Network). This is included as a security mechanisms, so messages from the Testnet Test Network cannot be replayed on the Mainnet.
