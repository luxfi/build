...
So let's get to it and interact with a precompile on the LUExchange-Chain of your local network. The SHA256 precompile is already available on the LUExchange-Chain.
