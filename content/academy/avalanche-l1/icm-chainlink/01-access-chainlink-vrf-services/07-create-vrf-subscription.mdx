...
To create a subscription, go to the Chainlink VRF Subscription Manager on the network where you plan to request VRF (e.g., Lux Testnet). You can access the manager here: [VRF | Subscription Management for Testnet](https://vrf.chain.link/testnet).
...
You can get testnet LINK tokens from the Testnet Faucet: [Chainlink Faucet for Testnet](https://faucets.chain.link/testnet)
