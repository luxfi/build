...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/lux-build/course-images/lux-fundamentals/9-JT3ORUzCZAILlQJjQaY2nJvFZHEVRL.png)
...
|Lux / Lux L1|2500 TPS|~0.8 seconds|

**TPS** &rarr; **Transactions per Second**

Returning to the highway analogy, these networks would look like this:

![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/lux-build/course-images/lux-fundamentals/10-M9xrguxF39gS0MkB03LHE1DcNDGsIV.png)
