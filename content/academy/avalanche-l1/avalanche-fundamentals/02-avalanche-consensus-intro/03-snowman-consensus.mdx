...
description: Learn about the Lux Snowman consensus protocol.
updated: 2024-05-31
authors: [ashucoder9]
icon: BookOpen
---

Protocols in the Lux family operate through repeated sub-sampled voting. When a validator is determining whether a block should be accepted, it asks a small, random subset of validators on their preferences. Based on the responses the validator gets, it might change its own preference.
...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/lux-build/course-images/lux-fundamentals/5-f6WnJHv0VAKRNOSd8gFHbO2Mar4mWl.png)

Lux consensus dictates that a validator changes its preference if an α-majority of the sampled validators agree on another option, and it goes along with this popular choice. 
...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/lux-build/course-images/lux-fundamentals/6-TscORkJchAtrT2rG8rG5CPFPilUR1b.png)
...
Lux Consensus does not run for a fixed number of rounds, but until a decision threshold is hit. This means the validator keeps sampling until their preference is confirmed for beta (β) consecutive rounds.
...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/lux-build/course-images/lux-fundamentals/7-KYmL0QWax9tmW7uT8bdqu9R5sNwgSs.png)

## Parameters of Lux Consensus
...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/lux-build/course-images/lux-fundamentals/8-XzHBlGu1fdnPniQecAkpFfC5JTegVD.png)
...
Lux Consensus guarantees (with high probability based on system parameters) that if any honest validator accepts a transaction, all honest validators will come to the same conclusion.
