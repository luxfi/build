...
description: Learn about Intain's permissioned Lux L1.
updated: 2024-06-28
authors: [usmaneth]
icon: Microscope
---

Intain operates a structured finance platform. It has **IntainMARKETS**, a marketplace for tokenized asset-backed securities built as an Lux L1.
