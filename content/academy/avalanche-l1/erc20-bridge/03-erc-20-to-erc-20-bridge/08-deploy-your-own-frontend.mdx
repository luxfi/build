...
In this section, you’ll learn how to deploy your own **ICTT frontend** using the BuilderKit and pre-configured tokens and chains. Follow these steps to quickly set up and test your own ICTT frontends with Lux L1s.
...
```tsx
export const CHAINS = [lux, luxTestnet, echo, dispatch, myblockchain];
```
...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/lux-build/course-images/interchain-token-transfer/site-running-IK70IqfXcCAYZBspWbomhiK601vB0e.png)
</Step>
</Steps>
