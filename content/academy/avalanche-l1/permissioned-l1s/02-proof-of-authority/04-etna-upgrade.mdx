...
The Etna upgrade, implemented through [ACP-77](/docs/acps/77-reinventing-subnets), represents a fundamental shift in how Lux approaches network creation and validation costs.
