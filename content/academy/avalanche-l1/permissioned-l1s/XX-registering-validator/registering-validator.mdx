...
[Teleporter](https://github.com/luxfi/teleporter) is a set of smart contracts that implements a rich messaging protocol on top of the Warp Messaging primitive, allowing for verified message passing between EVM chains. 
...
User submits EVM tx to smart contract [NativeTokenStakingManager.sol](https://github.com/luxfi/teleporter/blob/acp-77-updates/contracts/validator-manager/NativeTokenStakingManager.sol)
