...
![x402 payment flow for AI agents](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/lux-build/course-images/x402-payment-infrastructure/http402PaymentFlow.png)
