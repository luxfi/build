...
Alright, let's create our first contract. Head to the Lux Starter Kit Codespace and create a new folder called _my-contracts_ in the _contracts_ folder.

<Callout type="info">
**Remember, when restarting your Lux Starter Kit Codespace, you should restart your Lux network running the command `lux network start` in the terminal**
</Callout> 
