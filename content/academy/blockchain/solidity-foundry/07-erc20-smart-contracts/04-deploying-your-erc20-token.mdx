...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/lux-build/course-images/smartcontract-foundry/erc20-OpenZeppelin-gz9mc7CErNPx0PLFLwGMq2XBKlKOdE.png)
...
![](https://qizat5l3bwvomkny.public.blob.vercel-storage.com/lux-build/course-images/smartcontract-foundry/erc20-OpenZeppelin2-14GEmGL7MxlXGny0bUtZa3gjenHURz.png)
...
If you look at the righthand side of the Wizard page, you will see the button Copy to Clipboard. As the name might suggest, this allows us to copy our contract and paste it to a file in our Lux Starter Kit, which we can then compile and deploy onto the blockchain!
