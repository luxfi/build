...
As the name might suggest, this function returns the name of the token. As an example, for the Wrapped LUX contract, this would return "Wrapped LUX".
...
This function returns the ticker representation of the token. As an example, the United States Dollar usually has the ticker symbol "USD".  For Wrapped Lux, we have "WLUX".
