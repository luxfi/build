...
documentation: https://goldrush.dev/docs/chains/lux-c-chain
---
...
```
Learn more about GoldRush's integration with Lux LUExchange-Chain [here](https://goldrush.dev/docs/chains/lux-c-chain?utm_source=lux-c-chain&utm_medium=partner-docs) .
