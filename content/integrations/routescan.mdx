...
description: Routescan provides block explorer as a service for Lux L1s, offering real-time data on transactions, blocks, validators, and more.
...
4. **Customize Your Explorer**: Tailor the block explorer service to meet the specific needs of your Lux L1 project.
...
- **Blockchain Developers**: Integrate a scalable block explorer into your Lux L1 projects, providing users with real-time network data.
