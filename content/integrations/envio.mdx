...
- **EVM Compatibility**: Designed to work seamlessly with any EVM, including Lux's LUExchange-Chain and Layer 1 networks.
...
5. **Deploy on LUExchange-Chain and L1**: Utilize Envio for indexing on Lux's LUExchange-Chain and Layer 1 networks.
