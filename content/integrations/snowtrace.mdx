...
description: SnowTrace is a block explorer for the Lux network, providing real-time data on transactions, blocks, validators, and more.
...
- **Network Overview**: View a holistic overview of the Lux network, including key metrics and network status.
...
1. **Visit SnowTrace**: Navigate to the [SnowTrace website](https://snowtrace.io/) to begin exploring the Lux network.
...
4. **Check Network Status**: Monitor the overall health and status of the Lux network with real-time metrics.
