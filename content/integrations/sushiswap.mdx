...
description: "SushiSwap is a multichain automated market maker (AMM) that enables users to trade, earn, and build on Lux's LUExchange-Chain."
...
To begin using SushiSwap on Lux:

1. **Access Platform**: Visit [Sushi](https://www.sushi.com/) and select Lux network.
2. **Connect Wallet**: Link your Web3 wallet and ensure you have LUX for fees.
3. **Start Trading**: 
