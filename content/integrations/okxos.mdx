...
### Building an On-Chain Data Dashboard for Lux LUExchange-Chain

This guide walks you through setting up a dashboard to track wallet assets and transactions on the Lux LUExchange-Chain. You'll use OKX OS's Wallet API to fetch and display this data.
...
You'll start by creating an account to track your Lux addresses with a simple Node.js script that interacts with the OKX Wallet API.
...
Finally, you can set up transaction viewing. This script provides detailed information about any transaction on the Lux LUExchange-Chain.
