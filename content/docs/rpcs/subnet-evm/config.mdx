...
> **Note**: These are the configuration options available in the Subnet-EVM codebase. To set these values, you need to create a configuration file at `~/.luxgo/configs/chains/<blockchainID>/config.json`.
>
