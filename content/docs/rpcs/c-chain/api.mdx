...
<Callout title="info">
On the [public API node](https://github.com/docs/rpcs), it only supports LUExchange-Chain
websocket API calls for API methods that don't exist on the LUExchange-Chain's HTTP API
</Callout>
