---
title: "Exchange-Chain API"
description: "This page is an overview of the Exchange-Chain API associated with LuxGo."
edit_url: https://github.com/luxfi/luxgo/edit/master/vms/avm/service.md
---

The [Exchange-Chain](https://build.lux.network/docs/primary-network#x-chain),
Lux's native platform for creating and trading assets, is an instance of the Lux Virtual
Machine (AVM). This API allows clients to create and trade assets on the Exchange-Chain and other instances
of the AVM.

## Format

This API uses the `json 2.0` RPC format. For more information on making JSON RPC calls, see
[here](https://build.lux.network/docs/rpcs/other/guides/issuing-api-calls).

## Endpoints

`/ext/bc/X` to interact with the Exchange-Chain.
...
- `blockchainID` is the ID of the blockchain this transaction happened on. (Lux Mainnet
  Exchange-Chain is `2oYMBNV4eNHyqk2fjjV5nVQLDbtmNJzq5s3qs3Lo6ftnC6FByM`.)
...
:::caution
Endpoint deprecated as of [**v1.9.12**](https://github.com/luxfi/luxgo/releases/tag/v1.9.12).
