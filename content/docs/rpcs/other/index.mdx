---
title: "Admin RPC"
description: "This page is an overview of the Admin RPC associated with LuxGo."
edit_url: https://github.com/luxfi/luxgo/edit/master/api/admin/service.md
---
...
Now, calls to the Exchange-Chain can be made to either `/ext/bc/X` or, equivalently, to `/ext/myAlias`.
