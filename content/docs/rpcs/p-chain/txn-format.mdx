...
> **Note:** This transaction type has been disabled post-activation of LP-77 (Etna upgrade). The `TransformSubnetTx` is no longer accepted on the Platform-Chain after the activation of this upgrade.
