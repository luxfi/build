...
```bash
curl --location 'https://glacier-api.lux.network/v1/webhooks' \
...
```bash
curl --location --request PATCH 'https://glacier-api.lux.network/v1/webhooks/401da7d9-d6d7-46c8-b431-72ff1e1543f4/addresses' \
--header 'x-glacier-api-key: <YOUR_API_KEY>' \
--header 'Content-Type: application/json' \
--data '{
  "addresses": [
...
```bash
curl --location --request DELETE 'https://glacier-api.lux.network/v1/webhooks/401da7d9-d6d7-46c8-b431-72ff1e1543f4/addresses' \
--header 'x-glacier-api-key: <YOUR_API_KEY' \
--header 'Content-Type: application/json' \
--data '{
  "addresses": [
