...
description:  Learn how to remove a validator from an Lux L1.
---

### Remove a Validator from an Lux L1

```bash
lux blockchain removeValidator <blockchainName>
```
...
Choose the key to pay for the transaction fees on the Platform-Chain.
```bash
...
SetSubnetValidatorWeightTX fee: 0.000078836 LUX
