---
title: Installation
description: Instructions for installing and setting up the Lux-CLI.
---
...
To call the `lux` binary from anywhere, you'll need to add it to your system path. If you installed the binary into the default location, you can run the following snippet to add it to your path.
