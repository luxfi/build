...
Meet your instructors, the Developer Relations team at Lux Network, who are passionate about bringing the power of Lux to your fingertips. With their deep understanding of blockchain technology and a passion for simplifying complex concepts, they're here to provide you with a comprehensive and engaging learning experience.
...
<div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-3">
    { instructors.map(instructor => 
        <div key={instructor.name} class="p-5 bg-gray-50 rounded-lg shadow-sm flex flex-col dark:bg-gray-800 dark:border-gray-700">
            <a href={instructor.x} target='_blank' >
                ...
                <div class="flex space-x-4 sm:mt-0">
                    <a href={instructor.x} target='_blank' class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
