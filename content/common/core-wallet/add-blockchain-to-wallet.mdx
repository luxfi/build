...
You can find this information in the output of the `lux blockchain deploy myblockchain` command or by issuing the command `lux blockchain describe myblockchain`:
