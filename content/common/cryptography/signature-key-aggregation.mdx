...
Looks good so far, but let's now think about a message signed by a large portion of the Primary Network validators on Lux Mainnet. That would result in hundreds if not thousands of signatures attached to a small message.
