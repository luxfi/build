...
export async function GET(
  ...
  return new ImageResponse(
    OG({
      title: 'Tools',
      description: 'Discover developer tools and resources for building on Lux'
    }),
    {
      width: 1280,
      height: 720,
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{paddingLeft: "10px"}}>build.lux.network/<span style={{color: "red"}}>tools</span></span>
          </div>
        </div>
      </div>
    </div>
