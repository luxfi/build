...
export async function GET(
  ...
  return new ImageResponse(
    OG({
      title: 'Events',
      description: 'Discover upcoming events, hackathons, and conferences in the Lux ecosystem'
    }),
    {
      width: 1280,
      height: 720,
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{paddingLeft: "10px"}}>build.lux.network/<span style={{color: "red"}}>events</span></span>
          </div>
        </div>
      </div>
    </div>
