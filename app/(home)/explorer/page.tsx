...
export const metadata: Metadata = {
  title: "All Chains Explorer | Lux Ecosystem",
  description: "Explore all Lux L1 chains in real-time - blocks, transactions, and cross-chain messages across the entire ecosystem.",
  openGraph: {
    title: "All Chains Explorer | Lux Ecosystem",
    description: "Explore all Lux L1 chains in real-time - blocks, transactions, and cross-chain messages across the entire ecosystem.",
  },
